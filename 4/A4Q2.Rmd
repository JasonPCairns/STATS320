...
plot (c(x1[1,1], rep(x1[-1,1], each =2), x1[n1,1]), rep(x1[,2], each =2), col="blue",
      ...
      main="Simulated Number of Female Rats, by Week")
...
hist(simdist, xlim=c(0,80), breaks=50, prob=TRUE, 
     main="Histogram of Simulated Female Rat Population Distribution at 1 Year")
